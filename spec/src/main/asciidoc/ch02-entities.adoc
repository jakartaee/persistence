...
- any association targeting the second entity class is by nature a
  polymorphic association, and may reference an instance of the first
  entity class, and
- any Jakarta Persistence query against the second entity class is also
  polymorphic and may return an instance of the first entity class.
