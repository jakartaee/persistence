...
==== Persistent Attribute Type [[categories]]
...
<<categories>>, and if no equivalent mapping information is supplied in
any XML descriptor, nor via any provider-specific mechanism, the 
following defaulting rules are applied in order:
