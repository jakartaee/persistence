...
- an attribute of _basic type_, as defined in <<a486>>, or of a type
  converted to a basic type through use of a _converter_, as defined
  in <<a2999>>,
- an _embedded attribute_ whose type is a fine-grained embeddable
  class, as defined <<a487>>,
- an _element collection_, that is, a collection whose elements are
  instances of a basic type or embeddable class,
- a _relationship_ (or _association_) with another entity type,
