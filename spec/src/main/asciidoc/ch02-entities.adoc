...
These mapping strategies are enumerated by `jakarta.persistence.InheritanceType`,
and the mapping strategy for an entity class hierarchy may be specified by
the `@Inheritance` annotation or `inheritance` element of an XML descriptor,
as defined by <<a14891>>.
