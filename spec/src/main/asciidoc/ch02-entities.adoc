...
In the Java language, an instance of a non-primitive type has a
well-defined object identity unique to the instance and is passed
_by reference_, meaning that assignment of the instance to a field,
local variable, or method parameter, followed by later access to
the assigned value, preserves the identity of the instance.
