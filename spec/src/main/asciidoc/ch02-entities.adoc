...
1. If the type of the field or property is a class annotated with the
   ...
   and <<a14672>>.
2. Otherwise, if the type of the field or property is one of the basic
...
- If `object.getClass()` return a non-entity class, then `object` cannot
  ...
  type.
- A non-entity type may not be used in JPQL as the abstract schema type of
  a range variable declaration, as defined in <<a4766>>.
