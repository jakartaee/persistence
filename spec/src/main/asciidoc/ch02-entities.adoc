...
* An `Id` attribute of the dependent entity class which is mapped by a
  `ManyToOne` or `OneToOne` relationship to the parent entity annotated
  `@MapsId` must be of the same Java type as the `Id` attribute of the
  parent entity.

* An `EmbeddedId` attribute of the dependent entity class which is mapped
  by a `ManyToOne` or `OneToOne` relationship to the parent entity
  annotated `@MapsId` must be of the same Java type as the id class or
  embedded id of the parent entity.
