...
These interfaces may be found in <<Persistence SPI Interfaces>>/
...
This interface may be found in <<_persistenceprovider_>>.
...
This interface may be found in <<_providerutil_>>.

=== jakarta.persistence.spi.PersistenceUnitInfo Interface [[a13160]]

This interface may be found in <<_persistenceunitinfo_>>.
...
This interface may be found in <<_classtransformer_>>.
...
This interface may be found in <<_persistence_>>.
...
This interface may be found in <<_persistenceutil_>>.
