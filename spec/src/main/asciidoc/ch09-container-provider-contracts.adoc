...
must not attempt to create database schemas.footnote:[In Jakarta EE
environments, it is anticipated that the Jakarta EE platform provider may
wish to control the creation of database schemas rather than delegate this
task to the persistence provider. This property may also be specified in
...
These properties are used for script execution.footnote:[In Jakarta EE container
