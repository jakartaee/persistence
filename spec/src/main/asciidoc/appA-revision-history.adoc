...
Added `@PersistenceQuery`, `@NativeQuery`, `@QueryOptions`, and `StaticStatementReference` for declaring static queries at the method level, along with additional members of `TypedQueryReference`
