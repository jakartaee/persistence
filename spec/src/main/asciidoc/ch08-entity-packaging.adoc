...
persistence unit using the `class`, `package`, and `module` elements of the
...
- the following sub-elements:
  ...
  `mapping-file`, `jar-file`, `class`, `package`, `module`,
...
<persistence>
    <persistence-unit name="OrderManagement">
        ...
        <package>com.widgets</package>
        <module>com.widgets.orders</module>
    </persistence-unit>
</persistence>
----
...
===== mapping-file, jar-file, class, package, module, exclude-unlisted-classes [[a12305]]
...
corresponding `class`, `package`, or `module` element of the
`persistence.xml` file, or, for an ordinary Java type, in an XML mapping file.
...
The `package` element identifies one package descriptor whose annotations
belong to the persistence unit. Its value is the qualified package name, for
example, `com.example.model`, and not `com.example.model.package-info`.
Naming a package descriptor does not cause the ordinary Java types in that
package to belong to the persistence unit.

The `module` element identifies one module descriptor whose annotations
belong to the persistence unit. Its value is the declared JPMS module name and
not `module-info`. Naming a module descriptor does not cause the ordinary Java
types or package descriptors in that module to belong to the persistence unit.
