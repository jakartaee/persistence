...
The _qualifier_ element specifies the fully-qualified class name of
an annotation annotated _jakarta.inject.Qualifier_.

===== scope [[a12311]]

The _scope_ element specifies the fully-qualified class name of
an annotation annotated _jakarta.inject.Scope_ or
_jakarta.enterprise.context.NormalScope_.
