...
In Java SE environments, the persistence provider is not required to process any 
type, package descriptor, or module descriptor which is not explicitly listed in the 
