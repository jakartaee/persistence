...
annotation must be applied to the root entity of the graph or subgraph,
and specifies the limits of the graph of associated attributes and
...
persistence unit unless two `@NamedEntityGraph` annotations with the same
name describe a graph and one of its subgraphs, as specified by `@Fetch`
