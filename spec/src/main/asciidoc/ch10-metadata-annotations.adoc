...
eligible class belonging to the persistence unit, as defined in
<<canonical-metamodel>>
...
any eligible class belonging to the persistence unit, as defined in
<<canonical-metamodel>>.
...
to any eligible class belonging to the persistence unit, as defined in
<<canonical-metamodel>>.
...
be applied to any eligible class belonging to the persistence unit, as
defined in <<canonical-metamodel>>.
