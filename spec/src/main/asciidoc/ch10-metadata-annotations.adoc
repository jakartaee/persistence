...
The `EntityListeners` annotation specifies the entity listener
classes associated with the annotated class, package, or module.
...
- to a module descriptor to specify listener classes applying
  to every entity contained in any package belonging to the module.
