...
annotated entity class or mapped superclass and its subclasses.
...
invocation of default listeners is to be excluded for the entity
class (or mapped superclass) and its subclasses.
