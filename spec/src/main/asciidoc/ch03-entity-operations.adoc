...
A `@PrePersist`, `@PreRemove`, or `@PreMerge` methods is always
invoked synchronously during execution of the `persist()`, `merge()`,
or `remove()` operation of the `EntityManager`.
