...
It is the responsibility of the application to ensure that an instance is
associated with at most one persistence context. If an entity instance is
made managed in more than one persistence context, the behavior is undefined
and unportable.
