...
- Otherwise, if `FlushModeType.COMMIT` is set, the effect on the
  results of the query of pending modifications to entities in
  the persistence context is unspecified.
