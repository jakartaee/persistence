...
`Statement`, `TypedQuery`, or `StoredProcedureQuery` causes the current
transaction to be marked for rollback, unless the exception is an
instance of one of the following exception types:
