...
public interface EntityManager extends AutoCloseable {
     ...
     * {@code PersistenceException} is thrown.
...
public interface Query {
     ...
     * retrieve. Returns <code>Integer.MAX_VALUE</code> if {@code setMaxResults} was not
     ...
     * retrieve. Returns 0 if {@code setFirstResult} was not applied to the
     * query object.
    ...
    /**
     * Bind an instance of <code>java.util.Calendar</code> to a {@code Parameter} object.
     * @param param parameter object
     * @param value  parameter value
    ...
    /**
     * Bind an instance of <code>java.util.Date</code> to a {@code Parameter} object.
     * @param param parameter object
     * @param value  parameter value
     * @param temporalType  temporal type
     * @return the same query instance
 ...
 * the following:
 * <ul>
 * <li>The {@code setParameter} methods are used to set the values of
 ...
 * <li>
 * When {@code getResultList} and {@code getSingleResult} are
 * called on a {@code StoredProcedureQuery} object, the provider
 * will call {@code execute} on an unexecuted stored procedure
 * query before processing {@code getResultList} or
 * {@code getSingleResult}.</li>
 * <li>
 * When {@code executeUpdate} is called on a
 * {@code StoredProcedureQuery} object, the provider will call
 * {@code execute} on an unexecuted stored procedure query
 *  followed by {@code getUpdateCount}.  The results of
 ...
 * <li>
 * The {@code execute} method returns true if the first result is a
 ...
 * if any.</li>
 * <li>
 * If the {@code execute} method returns true, the pending result set
 * can be obtained by calling {@code getResultList} or
 * {@code getSingleResult}.</li>
 * <li>
 * The {@code hasMoreResults} method can then be used to test
 * for further results.</li>
 * <li>
 * If {@code execute} or {@code hasMoreResults} returns false,
 * the {@code getUpdateCount} method can be called to obtain the
 ...
 * <li>
 * After results returned through {@code getResultList} and
 * {@code getUpdateCount} have been exhausted, results returned through
 * {@code INOUT} and {@code OUT} parameters can be retrieved.</li>
 * <li>
 * The {@code getOutputParameterValue} methods are used to retrieve
 ...
 * update counts should be exhausted before calling {@code getResultList}
 * to retrieve the result set.  Alternatively, the {@code REF_CURSOR}
 * result set can be retrieved through {@code getOutputParameterValue}.
 ...
 * {@code INOUT} and {@code OUT} parameters, {@code execute}
 * can be followed immediately by calls to
 * {@code getOutputParameterValue}.</li>
 * </ul>
 *
 * @see Query
 * @see Parameter
