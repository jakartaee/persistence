...
* All existing copyright notices, or if one does not exist, a notice
  ...
  of the form:
+
> "Copyright (c) [$date-of-document] Eclipse Foundation, Inc.
> [$url to this license]"
...
> Copyright (c) 2018 Eclipse Foundation. This software or document
> includes material copied from or derived from [title and URI of
> the Eclipse Foundation specification document].
