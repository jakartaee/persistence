...
an element collection. The `MapKeyColumn` annotation is specified on the
...
The `OrderColumn` is used with owned collections. It annotation may be
...
side of the relationship that references the collection that ordered.
