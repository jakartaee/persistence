...
|String
|kind
|(Optional) A SQL fragment representing the index kind, usually inserted before the keyword `index` in the generated DDL which creates this index.
|Nothing appended.

|String
|type
|(Optional) A SQL fragment representing the index type. When specified, it is inserted into the generated DDL which creates this index.
|Nothing appended.
...
|String
|mappedBy
|The field of property of the target entity that owns the relationship
