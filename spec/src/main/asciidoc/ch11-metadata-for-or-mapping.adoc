...
The syntax of the `columnList` element is SQL
...
|String
|type
|(Optional) A SQL fragment representing the index type. When given and the database supports it, is inserted into the generated DDL which creates this index.
|Nothing appended.
