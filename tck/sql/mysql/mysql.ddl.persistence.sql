...
CREATE TABLE EMP_MAPKEYCOL2(ID NUMERIC NOT NULL, LASTNAMEEMPLOYEES_KEY VARCHAR(255), LASTNAME VARCHAR(255), THEDATE DATE ,FK_DEPT5 INT,  CONSTRAINT PK_EMP2 PRIMARY KEY(ID) ) ENGINE=innoDB DEFAULT CHARSET=latin1!
