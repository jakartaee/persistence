...
CREATE TABLE CUSTOMER_TABLE (ID VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), COUNTRY VARCHAR(255), CODE VARCHAR(255), FK5_FOR_CUSTOMER_TABLE VARCHAR(255), FK6_FOR_CUSTOMER_TABLE VARCHAR(255)) !
...
CREATE TABLE PRODUCT_TABLE (ID VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), PRICE DOUBLE PRECISION, QUANTITY INTEGER, PNUM INTEGER, PRODUCT_TYPE VARCHAR(255), INCEPTION DATETIME NULL, SOLD DATETIME NULL, MODEL INTEGER, REV DOUBLE PRECISION ) !
...
CREATE TABLE PRICED_PRODUCT_TABLE (ID VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), PRICE DOUBLE PRECISION, QUANTITY INTEGER, PNUM INTEGER ) !
...
CREATE TABLE SPOUSE_TABLE(ID VARCHAR(255) PRIMARY KEY NOT NULL,  FIRSTNAME VARCHAR(200), MAIDENNAME VARCHAR(200), LASTNAME VARCHAR(200), SOCSECNUM VARCHAR(255), FK7_FOR_CUSTOMER_TABLE VARCHAR(255), FK_FOR_INFO_TABLE VARCHAR(255))!
...
DROP TABLE PERSON !
CREATE TABLE PERSON (PERSONID INTEGER NOT NULL, FIRSTNAME VARCHAR(200) NULL, LASTNAME VARCHAR(200) NULL, PROJECT_PROJID INTEGER NULL, insurance_INSID INTEGER NULL, TEAM_TEAMID INTEGER NULL, CONSTRAINT PK_PERSON PRIMARY KEY (PERSONID)) !
...
DROP TABLE TEAM !
CREATE TABLE TEAM (NAME VARCHAR(200) NULL, TEAMID INTEGER NOT NULL,  COMPANY_COMPANYID INTEGER, CONSTRAINT PK_TEAM PRIMARY KEY (TEAMID)) !
...
CREATE TABLE DATATYPES (ID INTEGER NOT NULL, BOOLEANDATA SMALLINT NULL, CHARDATA CHAR NULL, SHORTDATA SMALLINT NULL, INTDATA INTEGER NULL, INTDATA2 INTEGER NULL, LONGDATA NUMERIC NULL, DBLDATA DOUBLE PRECISION NULL, FLOATDATA REAL NULL, BYTEDATA SMALLINT NULL, TRANS SMALLINT NULL, ENUMODATA INTEGER NULL, ENUMSDATA VARCHAR(25), BYTEARRAYDATA IMAGE, CHARARRAYDATA VARCHAR(448), CONSTRAINT PK_DATATYPE PRIMARY KEY (ID) )!
...
DROP TABLE ITEM !
CREATE TABLE ITEM (ID INTEGER PRIMARY KEY NOT NULL, ITEMNAME VARCHAR(200)) !
...
DROP TABLE MEMBER !
CREATE TABLE MEMBER (MEMBER_ID INTEGER NOT NULL, MEMBER_NAME VARCHAR(200), DUES SMALLINT NULL, VERSION INTEGER, DONATION NUMERIC, CONSTRAINT PK_MEMBER PRIMARY KEY (MEMBER_ID)) !
...
CREATE TABLE BEANEJB_1X1_BI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC , FK1_FOR_AEJB_1X1_BI_BTOB VARCHAR(255) , FK2_FOR_AEJB_1X1_BI_BTOB VARCHAR(255) , FK1_FOR_BEJB_1X1_BI_BTOB VARCHAR(255) , FK2_FOR_BEJB_1X1_BI_BTOB VARCHAR(255) )  !

DROP TABLE AEJB_1X1_BI_BTOB !
CREATE TABLE  AEJB_1X1_BI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC ) !

DROP TABLE BEJB_1X1_BI_BTOB !
CREATE TABLE BEJB_1X1_BI_BTOB ( ID VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), VALUE NUMERIC , FK_FOR_AEJB_1X1_BI_BTOB VARCHAR(255) ) !
...
CREATE TABLE BEANEJB_1X1_BI_CASCADE ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC , FK1_FOR_AEJB_1X1_BI_CASCADE VARCHAR(255) , FK2_FOR_AEJB_1X1_BI_CASCADE VARCHAR(255) , FK1_FOR_BEJB_1X1_BI_CASCADE VARCHAR(255) , FK2_FOR_BEJB_1X1_BI_CASCADE VARCHAR(255) ) !

DROP TABLE AEJB_1X1_BI_CASCADE !
CREATE TABLE  AEJB_1X1_BI_CASCADE ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC ) !

DROP TABLE BEJB_1X1_BI_CASCADE !
CREATE TABLE BEJB_1X1_BI_CASCADE ( ID  VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), VALUE NUMERIC , FK_FOR_AEJB_1X1_BI_CASCADE VARCHAR(255) )  !
...
CREATE TABLE BEANEJB_1X1_UNI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC , FK1_FOR_AEJB_1X1_UNI_BTOB VARCHAR(255) , FK2_FOR_AEJB_1X1_UNI_BTOB VARCHAR(255) , FK1_FOR_BEJB_1X1_UNI_BTOB VARCHAR(255) , FK2_FOR_BEJB_1X1_UNI_BTOB VARCHAR(255) )  !

DROP TABLE AEJB_1X1_UNI_BTOB !
CREATE TABLE  AEJB_1X1_UNI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC ) !

DROP TABLE BEJB_1X1_UNI_BTOB !
CREATE TABLE BEJB_1X1_UNI_BTOB ( ID  VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), VALUE NUMERIC , FK_FOR_AEJB_1X1_UNI_BTOB VARCHAR(255) )  !
...
CREATE TABLE BEANEJB_1XM_BI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC , FK1_FOR_AEJB_1XM_BI_BTOB VARCHAR(255) , FK2_FOR_AEJB_1XM_BI_BTOB VARCHAR(255) , FK1_FOR_BEJB_1XM_BI_BTOB VARCHAR(255) , FK2_FOR_BEJB_1XM_BI_BTOB VARCHAR(255) , FK3_FOR_BEJB_1XM_BI_BTOB VARCHAR(255) , FK4_FOR_BEJB_1XM_BI_BTOB VARCHAR(255) )  !

DROP TABLE AEJB_1XM_BI_BTOB !
CREATE TABLE  AEJB_1XM_BI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC ) !

DROP TABLE BEJB_1XM_BI_BTOB !
CREATE TABLE BEJB_1XM_BI_BTOB ( ID  VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), VALUE NUMERIC , FK_FOR_AEJB_1XM_BI_BTOB VARCHAR(255) )  !
...
CREATE TABLE BEANEJB_1XM_BI_CASCADE ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC , FK1_FOR_AEJB_1XM_BI_CASCADE VARCHAR(255) , FK2_FOR_AEJB_1XM_BI_CASCADE VARCHAR(255) , FK1_FOR_BEJB_1XM_BI_CASCADE VARCHAR(255) , FK2_FOR_BEJB_1XM_BI_CASCADE VARCHAR(255) )  !

DROP TABLE AEJB_1XM_BI_CASCADE !
CREATE TABLE  AEJB_1XM_BI_CASCADE ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC )  !

DROP TABLE BEJB_1XM_BI_CASCADE !
CREATE TABLE BEJB_1XM_BI_CASCADE ( ID  VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), VALUE NUMERIC , FK_FOR_AEJB_1XM_BI_CASCADE VARCHAR(255) )  !
...
CREATE TABLE BEANEJB_1XM_BI_DELETE ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200)  , VALUE NUMERIC , FK1_FOR_AEJB_1XM_BI_DELETE VARCHAR(255) , FK2_FOR_AEJB_1XM_BI_DELETE VARCHAR(255) , FK1_FOR_BEJB_1XM_BI_DELETE VARCHAR(255) , FK2_FOR_BEJB_1XM_BI_DELETE VARCHAR(255) )  !

DROP TABLE AEJB_1XM_BI_DELETE !
CREATE TABLE  AEJB_1XM_BI_DELETE ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC )  !

DROP TABLE BEJB_1XM_BI_DELETE !
CREATE TABLE BEJB_1XM_BI_DELETE ( ID  VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), VALUE NUMERIC , FK_FOR_AEJB_1XM_BI_DELETE VARCHAR(255) )  !
...
CREATE TABLE BEANEJB_1XM_UNI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC , FK1_FOR_AEJB_1XM_UNI_BTOB VARCHAR(255) , FK2_FOR_AEJB_1XM_UNI_BTOB VARCHAR(255) , FK1_FOR_BEJB_1XM_UNI_BTOB VARCHAR(255) , FK2_FOR_BEJB_1XM_UNI_BTOB VARCHAR(255) , FK3_FOR_BEJB_1XM_UNI_BTOB VARCHAR(255) , FK4_FOR_BEJB_1XM_UNI_BTOB VARCHAR(255) )  !

DROP TABLE AEJB_1XM_UNI_BTOB !
CREATE TABLE  AEJB_1XM_UNI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC )  !

DROP TABLE BEJB_1XM_UNI_BTOB !
CREATE TABLE BEJB_1XM_UNI_BTOB ( ID  VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), VALUE NUMERIC , FK_FOR_AEJB_1XM_UNI_BTOB VARCHAR(255) )  !
...
CREATE TABLE BEANEJB_MX1_UNI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC , FK1_FOR_AEJB_MX1_UNI_BTOB VARCHAR(255) , FK2_FOR_AEJB_MX1_UNI_BTOB VARCHAR(255) , FK1_FOR_BEJB_MX1_UNI_BTOB VARCHAR(255) , FK2_FOR_BEJB_MX1_UNI_BTOB VARCHAR(255) , FK3_FOR_BEJB_MX1_UNI_BTOB VARCHAR(255) , FK4_FOR_BEJB_MX1_UNI_BTOB VARCHAR(255) )  !

DROP TABLE AEJB_MX1_UNI_BTOB !
CREATE TABLE  AEJB_MX1_UNI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC )  !

DROP TABLE BEJB_MX1_UNI_BTOB !
CREATE TABLE BEJB_MX1_UNI_BTOB ( ID  VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), VALUE NUMERIC , FK_FOR_AEJB_MX1_UNI_BTOB VARCHAR(255) )  !
...
CREATE TABLE BEANEJB_MX1_UNI_DELETE ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC , FK1_FOR_AEJB_MX1_UNI_DELETE VARCHAR(255) , FK2_FOR_AEJB_MX1_UNI_DELETE VARCHAR(255) , FK1_FOR_BEJB_MX1_UNI_DELETE VARCHAR(255) , FK2_FOR_BEJB_MX1_UNI_DELETE VARCHAR(255) , FK3_FOR_BEJB_MX1_UNI_DELETE VARCHAR(255) , FK4_FOR_BEJB_MX1_UNI_DELETE VARCHAR(255) )  !

DROP TABLE AEJB_MX1_UNI_DELETE !
CREATE TABLE  AEJB_MX1_UNI_DELETE ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC )  !

DROP TABLE BEJB_MX1_UNI_DELETE !
CREATE TABLE BEJB_MX1_UNI_DELETE ( ID VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), VALUE NUMERIC , FK_FOR_AEJB_MX1_UNI_DELETE VARCHAR(255))  !
...
CREATE TABLE BEANEJB_MXM_BI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC , FK1_FOR_AEJB_MXM_BI_BTOB VARCHAR(255)  , FK2_FOR_AEJB_MXM_BI_BTOB VARCHAR(255) , FK3_FOR_AEJB_MXM_BI_BTOB VARCHAR(255) , FK4_FOR_AEJB_MXM_BI_BTOB VARCHAR(255) , FK1_FOR_BEJB_MXM_BI_BTOB VARCHAR(255) , FK2_FOR_BEJB_MXM_BI_BTOB VARCHAR(255) , FK3_FOR_BEJB_MXM_BI_BTOB VARCHAR(255) , FK4_FOR_BEJB_MXM_BI_BTOB VARCHAR(255) )  !

DROP TABLE AEJB_MXM_BI_BTOB !
CREATE TABLE  AEJB_MXM_BI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC ) !

DROP TABLE BEJB_MXM_BI_BTOB !
CREATE TABLE BEJB_MXM_BI_BTOB ( ID  VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), VALUE NUMERIC  ) !
...
CREATE TABLE BEANEJB_MXM_UNI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC , FK1_FOR_AEJB_MXM_UNI_BTOB VARCHAR(255) , FK2_FOR_AEJB_MXM_UNI_BTOB VARCHAR(255) , FK3_FOR_AEJB_MXM_UNI_BTOB VARCHAR(255) , FK4_FOR_AEJB_MXM_UNI_BTOB VARCHAR(255) , FK1_FOR_BEJB_MXM_UNI_BTOB VARCHAR(255) , FK2_FOR_BEJB_MXM_UNI_BTOB VARCHAR(255) , FK3_FOR_BEJB_MXM_UNI_BTOB VARCHAR(255) , FK4_FOR_BEJB_MXM_UNI_BTOB VARCHAR(255) )  !

DROP TABLE AEJB_MXM_UNI_BTOB !
CREATE TABLE  AEJB_MXM_UNI_BTOB ( ID VARCHAR(255)  PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE NUMERIC )  !

DROP TABLE BEJB_MXM_UNI_BTOB !
CREATE TABLE BEJB_MXM_UNI_BTOB ( ID  VARCHAR(255) PRIMARY KEY NOT NULL, NAME VARCHAR(200), VALUE NUMERIC  )  !
...
DROP TABLE A_BASIC !
CREATE TABLE A_BASIC ( ID VARCHAR(255)   PRIMARY KEY NOT NULL, NAME VARCHAR(200) , VALUE INT, BASICINTEGER INT, BASICSHORT SMALLINT, BASICBIGSHORT SMALLINT, BASICFLOAT FLOAT, BASICBIGFLOAT FLOAT, BASICLONG BIGINT, BASICBIGLONG BIGINT, BASICDOUBLE DOUBLE PRECISION, BASICBIGDOUBLE DOUBLE PRECISION, BASICCHAR CHAR, BASICCHARARRAY VARCHAR(448), BASICBIGCHARARRAY VARCHAR(448), BASICBYTEARRAY   VARBINARY(255), BASICBIGBYTEARRAY  VARBINARY(255), BASICBIGINTEGER DECIMAL(18,0), BASICBIGDECIMAL DECIMAL(18,0), BASICDATE DATE, BASICTIME TIME, BASICCALENDAR DATE, BASICTIMESTAMP DATETIME) !
...
CREATE TABLE A_BIGINTEGER ( ID VARCHAR(255), NAME VARCHAR(200) , VALUE INT, BASICINTEGER INT, BASICSHORT SMALLINT, BASICBIGSHORT SMALLINT, BASICFLOAT FLOAT, BASICBIGFLOAT FLOAT, BASICLONG BIGINT, BASICBIGLONG BIGINT, BASICDOUBLE DOUBLE PRECISION, BASICBIGDOUBLE DOUBLE PRECISION, BASICCHAR CHAR, BASICCHARARRAY VARCHAR(448), BASICBIGCHARARRAY VARCHAR(448), BASICBYTEARRAY   VARBINARY(255), BASICBIGBYTEARRAY  VARBINARY(255), BASICBIGINTEGER DECIMAL(18,0) PRIMARY KEY NOT NULL, BASICBIGDECIMAL DECIMAL(18,0), BASICDATE DATE, BASICTIME TIME, BASICCALENDAR DATE, BASICTIMESTAMP DATETIME) !

DROP TABLE A_BIGDECIMAL !
CREATE TABLE A_BIGDECIMAL ( ID VARCHAR(255), NAME VARCHAR(200) , VALUE INT, BASICINTEGER INT, BASICSHORT SMALLINT, BASICBIGSHORT SMALLINT, BASICFLOAT FLOAT, BASICBIGFLOAT FLOAT, BASICLONG BIGINT, BASICBIGLONG BIGINT, BASICDOUBLE DOUBLE PRECISION, BASICBIGDOUBLE DOUBLE PRECISION, BASICCHAR CHAR, BASICCHARARRAY VARCHAR(448), BASICBIGCHARARRAY VARCHAR(448), BASICBYTEARRAY   VARBINARY(255), BASICBIGBYTEARRAY  VARBINARY(255), BASICBIGINTEGER DECIMAL(18,0), BASICBIGDECIMAL DECIMAL(18,0) PRIMARY KEY NOT NULL, BASICDATE DATE, BASICTIME TIME, BASICCALENDAR DATE, BASICTIMESTAMP DATETIME)!
...
CREATE TABLE EMP_MAPKEYCOL(ID INTEGER PRIMARY KEY NOT NULL, FIRSTNAME VARCHAR(255) , LASTNAME VARCHAR(255), HIREDATE DATETIME NULL, SALARY REAL NOT NULL, STATUS VARCHAR(255),  FK_MGR INTEGER NULL, FK_DEPT INTEGER NULL, FK_DEPT3 INTEGER NULL, FK_DEPT4 INTEGER NULL, FK_PROJECT INTEGER NULL , FK_INS INTEGER NULL, OFFICE_ID VARCHAR(255), LASTNAMEEMPLOYEES_KEY VARCHAR(255)) !
